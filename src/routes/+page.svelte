...
<h3
	class="font-bold text-xl underline decoration-dotted underline-offset-2 decoration-neutral-500 hover:decoration-neutral-800 tracking-wide mb-4"
>
	Recent
</h3>
<!-- Notes Preview -->
			...
			<div id="" class="flex-1">
				<div class="flex flex-col gap-6">
					...
					<div class="relative mb-6">
						...
						>
						<small
							class="absolute flex justify-between w-full px-0 py-1 text-xs transition text-slate-400 peer-invalid:text-pink-500"
						>
